...
<html lang="en">
   ...
   <body class="main-layout">
    ...
    <div class="collection_text">Baja Imagenes</div>
                ...
                <div class="container">
                  <?php
                    ...
                    if(isset($_REQUEST['delete'])){
                      ...
                      $query = "DELETE FROM images WHERE ID = $_POST[img]";
                  ...
                  <form method = "post" enctype="multipart/form-data">
                    ...
                    <?php
                        $con = mysqli_connect($server,$db_user,$db_pass);
                        mysqli_select_db($con,$database);
                        $query = "SELECT A.immovables_ID, Name, ID, Frase FROM inamovibles A INNER JOIN images B ON A.immovables_ID = B.immovables_ID ORDER BY A.immovables_ID ASC";
