...
<html lang="en">
   ...
   <body class="main-layout">
		  ...
		  <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                  ...
                  <a class="nav-item nav-link" href="BajaInm.php">Inmuebles</a>
    ...
    <div class="collection_text">Baja Usuarios</div>
                ...
                <div class="container">
                  <?php
                    ...
                    if(isset($_REQUEST['delete'])){
                      ...
                      $query = "DELETE FROM accounts WHERE User_ID = $_POST[seccs]";
                  ...
                  <form method = "post" enctype="multipart/form-data">
                    ...
                    <?php
                        $con = mysqli_connect($server,$db_user,$db_pass);
                        mysqli_select_db($con,$database);
                        $query = "SELECT User_ID, User, Name FROM accounts ORDER BY User_ID ASC";
                        ...
                        ?>
                            <option value="<?php echo $resultados['User_ID']; ?>"><?php echo $resultados['User']."-".$resultados['Name']; ?></option>
                        <?php
                        }
                        mysqli_close($con);
                    ?>
